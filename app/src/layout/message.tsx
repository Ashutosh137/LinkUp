...
function Message({ message }: { message: Message }) {
    return (
        <Paper elevation={5} sx={{ padding: 2, borderRadius: 2, marginBottom: 2, backgroundColor: 'background.paper' }}>
            <Stack direction="row"  spacing={2} alignItems="flex-start">
                ...
                <Stack spacing={1} sx={{ flex: 1 }}>
                    <Typography variant="body1" fontWeight="bold" textTransform={"capitalize"} color="text.primary">
                        {message.name}
                    </Typography>
